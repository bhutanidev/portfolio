    ...
    <div className="md:w-1/2 bg-muted/50 p-6 rounded-lg shadow-lg w-full max-w-md text-center">
      ...
      <div className="flex flex-col space-y-3">
        <div className="flex items-center justify-center space-x-2 bg-primary p-3 rounded-lg hover:bg-green-600 transition">
          ...
          <span className="font-mono">devbhutani10@gmail.com</span>
        </div>

        <a href="https://www.linkedin.com/in/dev-bhutani-9b983428b/" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center space-x-2 bg-primary p-3 rounded-lg hover:bg-green-600 transition">
          <Linkedin className="h-6 w-6" />
          <span className="font-mono">Linkedin</span>
        </a>

        <a href="https://x.com/dev_bhutan10" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center space-x-2 bg-primary p-3 rounded-lg hover:bg-green-600 transition">
          <Twitter className="h-6 w-6" />
          <span className="font-mono">X.com</span>
        </a>
        <a href="https://drive.google.com/file/d/1VMbpJNmjcCynlioF9JvmITI8yPifD8tq/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center space-x-2 bg-primary p-3 rounded-lg hover:bg-green-600 transition">
