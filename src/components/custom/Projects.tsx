    ...
    <div className="max-w-4xl mx-auto text-center py-1">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {projects.map((project, index) => (
          <Card key={index} className="bg-black mx-3 md:mx-0 text-white p-4 rounded-xl shadow-lg overflow-hidden">
            ...
            <CardContent className="text-left mt-4">
              ...
              <p className="text-gray-400 font-mono text-sm mt-2">{project.description}</p>
